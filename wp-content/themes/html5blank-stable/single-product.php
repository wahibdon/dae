<?php get_header(); ?>
	...
	<section id="images-rec">
		<ul id="product-actions">
			<li><a href=""><img src="images/share.gif" /></a></li>
			<li><a href=""><img src="images/print.gif" /></a></li>
			<li><a href=""><img src="images/manual.gif" /></a></li>
			<li><a href=""><img src="images/spec.gif" /></a></li>
		</ul>
		<div id="slideshow">
			<div>
